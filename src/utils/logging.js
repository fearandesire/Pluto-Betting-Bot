...
export const labelMsg = (label, msg) => ({
	label,
	message: msg,
})
...
export const debugLog = winston.createLogger({
	...
	transports: [
		new winston.transports.File({
			filename:
				'logs/debug/error/globalDebugErrors.log',
			level: 'error',
		}),
		new winston.transports.File({
...
export const overallLog = winston.createLogger({
	...
	transports: [
		...
		new winston.transports.File({
			filename: 'logs/global/testing.log',
		}),
		consoleTransport,
	],
})
...
export const memLog = winston.createLogger({
	...
	transports: [
		...
		new winston.transports.File({
			filename: 'logs/system/memory.log',
		}),
		consoleTransport,
	],
})
...
export const validateExistingUserLog = winston.createLogger(
	{
		...
		transports: [
			new winston.transports.File({
				filename:
					'logs/validateExistingUserError.log',
				level: 'error',
			}),
			new winston.transports.File({
				filename: 'logs/validateExistingUser.log',
			}),
		],
	},
)
...
export const processDailyClaimLog = winston.createLogger({
	...
	transports: [
		...
		new winston.transports.File({
			filename: 'logs/processDailyClaim.log',
		}),
	],
})
...
export const registerUserLog = winston.createLogger({
	...
	transports: [
		...
		new winston.transports.File({
			filename: 'logs/registerUser.log',
		}),
	],
})
...
export const checkCompletedLog = winston.createLogger({
	...
	transports: [
		new winston.transports.File({
			filename:
				'logs/closeBetOp/err/2. checkCompletedErr.log',
			level: 'error',
		}),
		new winston.transports.File({
			filename:
				'logs/closeBetOp/0. allClosingInfo.log',
			level: 'error',
		}),
		new winston.transports.File({
			filename:
				'logs/closeBetOp/2. checkCompleted.log',
		}),
		new winston.transports.File({
			filename:
				'logs/closeBetOp/0. allClosingInfo.log',
...
export const initCloseBetLog = winston.createLogger({
	...
	transports: [
		new winston.transports.File({
			filename:
				'logs/closeBetOp/err/3. initCloseBetErr.log',
			level: 'error',
		}),
		new winston.transports.File({
...
export const closeMatchupsLog = winston.createLogger({
	...
	transports: [
		new winston.transports.File({
			filename:
				'logs/closeBetOp/4. closeMatchups.log',
			level: 'error',
		}),
		new winston.transports.File({
			filename:
...
export const deleteBetArrLog = winston.createLogger({
	...
	transports: [
		new winston.transports.File({
			filename:
				'logs/closeBetOp/err/5. deleteBetArrErr.log',
			level: 'error',
		}),
		new winston.transports.File({
...
export const storeMatchupsLog = winston.createLogger({
	...
	transports: [
		...
		new winston.transports.File({
			filename: 'logs/storeMatchups.log',
		}),
	],
})
...
export const resolveMatchupLog = winston.createLogger({
	...
	transports: [
		...
		new winston.transports.File({
			filename: 'logs/resolveMatchup.log',
		}),
	],
})
...
export const resolveTeamLog = winston.createLogger({
	...
	transports: [
		new winston.transports.File({
			filename:
				'logs/err/resolveTeam/resolveTeamErr.log',
			level: 'error',
		}),
		new winston.transports.File({
...
export const betsFromIdLog = winston.createLogger({
	...
	transports: [
		new winston.transports.File({
			filename:
				'logs/closeBetOp/err/3.5 betsFromIdErr.log',
			level: 'error',
		}),
		new winston.transports.File({
...
export const locateMatchupIdLog = winston.createLogger({
	...
	transports: [
		new winston.transports.File({
			filename:
				'logs/closeBetOp/err/locateMatchupId.log',
			level: 'error',
		}),
		new winston.transports.File({
...
export const completedDebug = winston.createLogger({
	...
	transports: [
		new winston.transports.File({
			filename:
				'logs/closeBetOp/err/completedDebug.log',
			level: 'error',
		}),
		new winston.transports.File({
			filename:
