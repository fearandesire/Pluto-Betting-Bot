/**
 * @description Shared footer messages that appear across multiple contexts
 * Centralized here for single-point updates
 */
const SHARED_MESSAGES = {
	gamblerHotline: '📞 Addicted? Call 1-800-GAMBLER',
	rollTheDice: '🎲 Roll the dice! Your rent payment depends on it.',
	toTheMoon: '🚀 To the moon! Or at least to the next payout.',
	strategicInvesting:
 ...
 * Used as fallback when Khronos configuration is unavailable
 */
export const FALLBACK_FOOTERS = {
	core: [
		'💲 Use /balance to check your profile',
		'👁️ Use /commands to see all commands',
		'❓ Learn more about Pluto via /help',
		SHARED_MESSAGES.gamblerHotline,
	...
	general: [
		...
		SHARED_MESSAGES.gamblerHotline,
		SHARED_MESSAGES.rollTheDice,
		SHARED_MESSAGES.strategicInvesting,
...
export type FooterTypes = keyof typeof FALLBACK_FOOTERS | 'all'
