...
//? Mod & Admin Roles
export const modRoles = ['777388833104199700']
...
export const NFL_completedCheckTimes = {
    [`Thur`]: process.env.NFL_THURTIME,
    [`Sun`]: process.env.NFL_SUNTIME,
    [`Mon`]: process.env.NFL_MONTIME,
}
