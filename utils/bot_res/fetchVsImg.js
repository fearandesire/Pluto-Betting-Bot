...
export async function fetchVsImg(searchTerm) {
  ...
  await page.type('body > div.L3eUgb > div.o3j99.ikrT4e.om7nvf > form > div:nth-child(1) > div.A8SBwf > div.RNNXgb > div > div.a4bIc > div', `${searchTerm} ESPN`);
  ...
  await page.waitForSelector(`#Sva75c > div.DyeYj > div > div.dFMRD > div.pxAole > div.tvh9oe.BIB1wf > c-wiz > div > div.OUZ5W > div.zjoqD > div.qdnLaf.isv-id.b0vFpe > div > a > img`, {timeout: 5000})
   // Retrieving the URL of the image
   const imgUrl = await page.evaluate(async () => {
   const getImage = await document.querySelector("#Sva75c > div.DyeYj > div > div.dFMRD > div.pxAole > div.tvh9oe.BIB1wf > c-wiz > div > div.OUZ5W > div.zjoqD > div.qdnLaf.isv-id.b0vFpe > div > a > img").getAttribute("src");
   return getImage;
   });
