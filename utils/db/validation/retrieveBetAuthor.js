 ...
 * This function will query the database and retrieve the data from '"NBAactivebets"' table via the user and bet IDs.
...
export function retrieveBetAuthor(userid, betid) {
	return db.many(
		`SELECT * FROM "NBAactivebets" WHERE userid = $1 AND betid = $2`,
		[userid, betid],
	)
}
