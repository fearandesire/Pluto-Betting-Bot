 ...
 * ! It's important to note that we are calling the '"NBAactivebets"' table, not the '"NBAbetslips"' table. Long term: this may be re-visited.
...
export function hasActiveBets(userid) {
	...
	return db.any(`SELECT * FROM "NBAactivebets" WHERE userid = $1`, [userid])
}
