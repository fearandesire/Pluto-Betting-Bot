 ...
 * @returns - If the user confirms the bet, pushes bet to DB with [addNewBet](./addnewBet.js) (which will provide a response to user) && subtracts/sorts their new balance with {@link sortBalance}
